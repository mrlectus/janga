      ...
      return typeof (data) !== undefined && currentPosts.map((item, index) => {
        return (
          <tr>
            ...
            <td className={item.inspectionstatus === "approved" ? 'badge bg-success mt-3' : item.inspectionstatus == "pending" ? "badge bg-warning mt-3" : item.inspectionstatus === "rejected" ? 'badge bg-danger mt-3' : ""}>{(item.inspectionstatus)}</td>
              ...
              <ul className="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="#dropdownMenuButton2">
                ...
                <li className="mb-2">
                  <a className="dropdown-item border-radius-md" href="javascript:;">
                    <div className="d-flex py-1">
                      <h6 className="text-sm font-weight-normal mb-1">
                        <span id={item.userid} onClick={() => this.getCertificate(`${item.locationaddress}, ${item.businesstype}, ${item.registrationnumber}, ${item.organisationname}, ${item.leadfoodscientistname}, ${item.registrationnumber} `)} className="font-weight-bold" data-bs-toggle="modal" data-bs-target="#viewCert">View Certificate</span>
                      </h6>
                    </div>
                  </a>
                </li>
                    ...
                    <div class="card my-3">
                      <div class="card-header pb-4 bg-success">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                          <h5 className="text-light">All Premises Applications</h5>
                          {/*
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <embed type="application/pdf" src={this.state.premisesCertificate} width="600" height="400"></embed>
