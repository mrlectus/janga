...
class NewFoodScientistRegistrations extends PureComponent {
  ...
  downloadCert = async (values, values2 = []) => {
    ...
    let date = moment(val[1]).format("D MMMM YYYY ");
    console.log("date", date, val[1]);
    console.log("val", val);
    try {
      ...
      const payload = {
        ...
        id: val[0],
        nameOfCompany: `${
          values2[0].charAt(0).toUpperCase() + values2[0].slice(1)
        } ${values2[1]} ${values2[2]}`,
      };
        ...
        currentPosts.map((item, index) => {
          ...
          return (
            <tr>
              ...
              <td className="text-xs font-weight-bold">
                {moment(item.applicationdate).format("LL") === "Invalid date"
                  ? null
                  : moment(item.applicationdate).format("LL")}
              </td>
              <td className="text-xs font-weight-bold">
                {moment(item.registrationdate).format("LL") === "Invalid date"
                  ? null
                          ...
                          <div className="d-flex py-1">
                            <h6 className="text-sm font-weight-normal mb-1">
                              <span
                                ...
                                onClick={() =>
                                  this.downloadCert(
                                    `${item?.registrationnumber}, ${item.registrationdate}, ${item.organization}`,
                                    [item.title, item.othernames, item.surname],
                                  )
                                }
                              >
                                View Reg. Certificate
                              </span>
                            </h6>
                          </div>
                        </a>
                        ...
                        <div className="d-flex py-1">
                          <h6 className="text-sm font-weight-normal mb-1">
                            <span
                              id={item.formid}
                              onClick={() =>
                                this.reviewRegistration(item.formid)
                              }
                              className="font-weight-bold"
                            >
                              Approve / Reject
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button
                          ...
                          id={item.formid}
                          onClick={() => this.cancelApplication(item.formid)}
                        >
                      ...
                      <div class="card-header pb-4 bg-success">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                          <h5 className="text-light font-weight-bold">
                            All Registered Food Scientists
                          </h5>
                        </div>
                      </div>
                      <div class="card-body">
                          ...
                          <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                            <div className="modal-content">
                              <div className="modal-header bg-success d-flex align-items-center justify-content-between">
                                <h5 className="modal-title text-light font-weight-bold">
                                ...
                                <button
                                  type="button"
                                  className="btn btn-link text-light m-0 p-0 text-dark fs-4"
                                  data-bs-dismiss="modal"
                                  aria-label="Close"
                                >
                                  <span
                                                          ...
                                                          <div className="col-sm-6 col-lg-4 col-md-6 mb-3">
                                                            ...
                                                            <input
                                                              className={
                                                                item.applicationstatus ===
                                                                "pending"
                                                                  ? "bg-warning text-dark form-control shadow-none"
                                                                  : item.applicationstatus ===
                                                                    "approved"
                                                                  ? "bg-success text-light form-control shadow-none"
                                                                  : item.applicationstatus ===
                                                                    "rejected"
                                                                  ? "bg-danger text-light form-control shadow-none"
                                                                  : "form-control"
                                                              }
                                                              type="text"
                                                              value={
                                                          ...
                                                          >
                                                            {item.nifstcertificateimage ? (
                                                              <img
                                                                ...
                                                                width="306"
                                                                height="306"
                                                                src={`${item.nifstcertificateimage}`}
                                                              />
                                                            ) : (
                                                              <img
                                                                src="../assets/images/image.jpeg"
                                                          ...
                                                          <center>
                                                            {item.registrationcertificate ? (
                                                              <img
                                                                ...
                                                                width="450"
                                                                height="450"
                                                                src={`${item.registrationcertificate}`}
                                                              />
                                                            ) : (
                                                              <p>
                                                                No certificate
