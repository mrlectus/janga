        ...
        return (
          <tr>
              ...
              <button
                className={
                  item.taskstatus === "APPROVED"
                    ...
                    ? "btn btn-warning badge badge-warning text-xs font-weight-bold"
                    : item.taskstatus === "INITIATED"
                    ? "btn btn-primary badge badge-primary text-xs font-weight-bold"
            ...
            <td className="text-xs font-weight-bold">
              {moment(item.dateassigned).format("LL")}
            </td>
            <td className="text-xs font-weight-bold">
                  ...
                  >
                    <div className="d-flex py-1">
                      <h6 className="text-sm font-weight-normal mb-1">
                        <span
                          id={item.userid}
                          onClick={() => this.getReviewDetails(item.userid)}
                          className="font-weight-bold"
                          data-bs-toggle="modal"
                  ...
                  >
                    <div className="d-flex py-1">
                      <h6 className="text-sm font-weight-normal mb-1">
                        <span
                          id={item.userid}
                          onClick={() => this.approveRegistration(item.userid)}
                          className="font-weight-bold"
                          data-bs-toggle="modal"
