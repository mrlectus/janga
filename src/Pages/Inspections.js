...
class Inspection extends Component {
  constructor(props) {
    ...
    this.handleInspectionDateChange =
      this.handleInspectionDateChange.bind(this);
  ...
  showCompanySize() {
    return this.state.companySize.map((item) => {
      return (
        <option
          disabled={item.paymentcategory !== "annual" ? "disabled" : null}
          value={`${item.paymenttype},${item.amount}, ${item.description}, ${item.paymentcategory}, ${item.paymentsubcategory}, ${item.remitaid}`}
        >
          {item.paymentcategory === "annual" ? item.paymentsubcategory : null}
        </option>
      );
    });
  }
  ...
  addInspection = async () => {
    ...
    await fetch(`${baseUrl}Inspection/submitInspection`, obj)
      ...
      .then((responseJson) => {
        if (
          responseJson.message === "Inspection Report Submitted Successfully"
        ) {
    ...
    await fetch(`${baseUrl}Inspection/inspectionOfficial`, obj)
      ...
      .then((responseJson) => {
        ...
        if (
          ...
          "Inspection Official Details Updated Successfully"
        ) {
          Swal.fire({
            title: "Success",
                  ...
                  >
                          ...
                          <div className="d-flex py-1">
                            <h6 className="text-sm font-weight-normal mb-1">
                              <span
                                id={item.recid}
                                onClick={() =>
                                  this.getInspectionDetails(item.recid)
                                }
                        ...
                        >
                          <div className="d-flex py-1">
                            <h6 className="text-sm font-weight-normal mb-1">
                              <span
                                id={item.recid}
                                onClick={() => this.getBookRecordId(item.recid)}
                                className="font-weight-bold"
                              >
                                Book Inspection
                              </span>
                    ...
                    {parseInt(localStorage.getItem("inspection")) === 1 && (
                      <li
                        className="mb-2"
                        data-bs-toggle="modal"
                        data-bs-target="#submitInspection"
                      >
                        <a
                          className="dropdown-item border-radius-md"
                          href="javascript:;"
                          ...
                          <div className="d-flex py-1">
                            <h6 className="text-sm font-weight-normal mb-1">
                              <span
                                id={item.recid}
                                onClick={() =>
                                  this.getInspectionRecordId(item.recid)
                                }
                                className="font-weight-bold"
                              >
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button
                          ...
                          id={item.formid}
                          onClick={() => this.cancelInspection(item.recid)}
                        >
          ...
          <div className="col-md-10">
            ...
            >
                        ...
                        <div class="card-body">
                          {loading ? (
                            ...
                            <div class="table-responsive p-0 pb-2">
                              ...
                              {noRecords && (
                                <center>
                                  <p>No inspection record found.</p>
                                </center>
                              )}
                            </div>
                          )}
                          ...
                          {isInspectionLoading ? (
                            ...
                            <div className="d-flex flex-column">
                              {this.state.inspectionData.length > 0 &&
                                this.state.inspectionData.map((item) => {
                                  return (
                                    <main
                                      class="main-content position-relative max-height-vh-100 h-100 border-radius-lg "
                                      style={{
                                                ...
                                                <form className="row">
                                                  ...
                                                  <div className="col-sm-6 col-lg-4 col-md-6 mb-3">
                                                    ...
                                                    <div className="input-group input-group-outline mb-3">
                                                      ...
                                                      <input
                                                        className={
                                                          item.inspectionstatus.toLowerCase() ===
                                                          "pending"
                                                            ? "form-control bg-warning text-light shadow-none"
                                                            : item.inspectionstatus.toLowerCase() ===
                                                              "approved"
                                                            ? "form-control bg-success text-light"
                                                            : item.inspectionstatus.toLowerCase() ===
                                                              "rejected"
                                                            ? "form-control bg-danger text-light"
                                                            : ""
                                                        }
                                                        type="text"
                                                        value={
              ...
              <div
                ...
                id="submitInspection"
                tabindex="-1"
                aria-labelledby="submitInspection"
                aria-hidden="true"
              >
                <div class="modal-dialog">
                  <div class="modal-content">
                                  ...
                                  <div className="col-sm-12 col-lg-12 col-md-12 mb-3">
                                    ...
                                    <div className="input-group input-group-outline mb-3">
                                      ...
                                      <input
                                        ...
                                        onChange={(e) =>
                                          this.setState({
                                            followUpRemarks: e.target.value,
                                          })
                                        }
                                        type="text"
                                      />
                        ...
                        <div className="input-group input-group-outline mb-3">
                          ...
                          />
                                  ...
                                  <div className="col-sm-12 col-lg-12 col-md-12 mb-3">
                                    <label
                                      style={{
                                        color: this.state.colorApproval,
                                      }}
                                      className="form-label"
                                    >
                                      Approval Date{" "}
                                  ...
                                  <div className="col-sm-6 col-lg-12 col-md-4 mb-3">
                                    <label
                                      style={{
                                        color: this.state.reportImageColor,
                                      }}
                                      htmlFor="floatingInputCustom"
                                    >
                                      Upload Report Image
