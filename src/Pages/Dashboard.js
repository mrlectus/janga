...
class Dashboard extends Component {
    ...
    await fetch(`${baseUrl}UsersMgt/GetUsersByType/public`, obj)
      ...
      .then((responseJson) => {
        if (responseJson.status === 401) {
          ...
          this.setState({
            numberOfPublicUsers: responseJson.length,
            isCountingPublicUsers: false,
          });
        } else {
          this.setState({
            numberOfPublicUsers: "No registered users",
            isCountingPublicUsers: false,
          });
        }
      })
    ...
    await fetch(`${baseUrl}UsersMgt/GetUsersByType/private`, obj)
      ...
      .then((responseJson) => {
        if (responseJson.status === 401) {
          ...
          this.setState({
            numberOfAdminUsers: responseJson.length,
            isCountingAdminUsers: false,
          });
        } else {
          this.setState({
            numberOfAdminUsers: "No registered users",
            isCountingAdminUsers: false,
          });
        }
      })
    ...
    await fetch(`${baseUrl}Registration/getAllRegistration`, obj)
      ...
      .then((responseJson) => {
        if (responseJson.status === 401) {
          ...
          this.setState({
            numberOfFoodScientists: responseJson.length,
            isCountingFoodScientists: false,
          });
        } else {
          this.setState({
            numberOfFoodScientists: "No registered food scientists",
            isCountingFoodScientists: false,
          });
        }
      })
    ...
    await fetch(`${baseUrl}License/getAllLicense`, obj)
      ...
      .then((responseJson) => {
        if (responseJson.status === 401) {
          ...
          this.setState({
            numberOfRegisteredLicence: responseJson.length,
            isCountingLicence: false,
          });
        } else {
          this.setState({
            numberOfRegisteredLicence: "No registered licenced user",
            isCountingLicence: false,
          });
        }
      })
    ...
    await fetch(`${baseUrl}Payments/getAllPayments`, obj)
      ...
      .then((responseJson) => {
        if (responseJson.status === 401) {
          ...
          this.setState({
            numberOfPayments: responseJson.length,
            isCountingPayments: false,
          });
        } else {
          this.setState({
            numberOfPayments: "No payment has been recorded",
            isCountingPayments: false,
          });
        }
      })
  ...
  render() {
    const {
      isCountingPublicUsers,
      isCountingAdminUsers,
      isCountingFoodScientists,
      isCountingLicence,
      isCountingPayments,
      numberOfPayments,
      numberOfRegisteredLicence,
                  ...
                  <div class="card bg-success">
                    <div class="card-header bg-success p-3 pt-2">
                      ...
                      <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-light text-capitalize fw-bold">
                          All Public Users
                        </p>
                      </div>
                    </div>
              ...
              <div class="row mt-4">
                <div class="col-lg-4 col-md-6 mt-4 mb-4">
                  <div class="card bg-primary z-index-2 ">
                    <div class="card-body">
                      <h6 class="mb-0 text-light font-weight-bold text-end">
