...
class PremisesRenewals extends PureComponent {
  constructor(props){
      super(props);
      this.state = {
          data: [],
  ...
  showLicenses = async () => {
      ...
      await fetch(`${baseUrl}Premises/getAllOldPremises`, obj)
        .then((response) => response.json())
        .then((responseJson) => {
          console.warn(responseJson);
                      ...
                      <a class="dropdown-item border-radius-md" href="javascript:;">
                        <div class="d-flex py-1">
                            <h6 class="text-sm font-weight-normal mb-1">
                              <span class="font-weight-bold">Upload Certificate</span>
                            </h6>
                        </div>
                      </a>
                    </li>
           ...
           <div class="card my-3">
             <div class="card-header pb-4 bg-success">
               <div class="d-flex flex-wrap align-items-center justify-content-between">
                 <h5 className="text-light">Premises Renewals</h5>
                 {/*
                 ...
                 <div className="modal-body">
                   <div className="row">
                     <div clasNames="d-flex px-3">
                       ...
                       { isLoading ? <center><Spinner animation="border" className="text-center" variant="primary" size="lg" /></center>  :
...
export default PremisesRenewals
