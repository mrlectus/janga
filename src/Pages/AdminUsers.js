...
class AdminUsers extends PureComponent {
  constructor(props) {
    ...
    this.handleCanApproveRegistration =
      this.handleCanApproveRegistration.bind(this);
    ...
    this.handleCanApproveInspection =
      this.handleCanApproveInspection.bind(this);
  }
  ...
  handleCanApproveLicense(e) {
    e.target.checked === true
      ? this.setState({ canApproveLicense: 1 })
      : this.setState({ canApproveLicense: 0 });
  }
  handleCanApproveRegistration(e) {
    e.target.checked === true
      ? this.setState({ canApproveRegistration: 1 })
      : this.setState({ canApproveRegistration: 0 });
  }
  handleCanApprovePremises(e) {
    e.target.checked === true
      ? this.setState({ canApprovePremises: 1 })
      : this.setState({ canApprovePremises: 0 });
  }
  handleCanApprovePayments(e) {
    e.target.checked === true
      ? this.setState({ canApprovePayments: 1 })
      : this.setState({ canApprovePayments: 0 });
  }
  handleCanApproveInspection(e) {
    e.target.checked === true
      ? this.setState({ canApproveInspection: 1 })
      : this.setState({ canApproveInspection: 0 });
  }
      ...
      return currentPosts.map((item, index) => {
        return (
          <tr>
            ...
            item.email === "superadmin@superadmin.com" ? null : (
              <td>
                <button
                    ...
                    <span>
                      ...
                      localStorage.getItem("email") ===
                        ...
                        <li
                          ...
                          id={item.userId}
                          onClick={() =>
                            this.getEnabledUserDetails(item.userId)
                          }
                          data-bs-toggle="modal"
                    ...
                    <span>
                      ...
                      localStorage.getItem("email") ===
                        ...
                        <li
                          ...
                          id={item.userId}
                          onClick={() =>
                            this.getDisabledUserDetails(item.userId)
                          }
                          data-bs-toggle="modal"
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                      ...
                      localStorage.getItem("email") ===
                        ...
                        <div class="d-flex align-items-center">
                          <button
                            class="btn bg-warning font-weight-bold mb-0 text-dark"
                            data-bs-toggle="modal"
