...
class CreateUser extends Component {
    constructor(props) {
      ...
      checkValidation = () => {
        const { email, password, selectValue, confirm_password, user_role, user_status, user_type, phone } = this.state;
        if( email === null ) {
          Swal.fire({
            title: "Empty",
          ...
          this.setState({error_user_role: 'red', error_confirm_password: "black"})
                ...
                <div className="container" style={{ marginTop: 0 }}>
                  <Form>
                    <Form.Floating className="mb-3">
                      ...
                      />
                      <label style={{ color: this.state.error_email }} htmlFor="email">Email</label>
                    </Form.Floating>
                    <FloatingLabel className="mb-3" controlId="floatingSelectGrid">
                      <select
                        className="form-control shadow-none"
                      ...
                      <option disabled selected>--Select Region --</option>
                        ...
                        <label style={{ color: this.state.error_region }} htmlFor="region">Region</label>
                    </FloatingLabel>
                    <Form.Floating className="mb-3">
                      <input
                        className="form-control shadow-none"
                      ...
                      />
                      <label style={{ color: this.state.error_phone }} htmlFor="phone">Phone</label>
                    </Form.Floating>
                    ...
                    <Form.Floating className="mb-3">
                      ...
                      />
                      <label style={{ color: this.state.error_password }} htmlFor="floatingPasswordCustom">Password</label>
                    </Form.Floating>
                    ...
                    <Form.Floating className="mb-3">
                      ...
                      />
                      <label style={{ color: this.state.error_confirm_password }} htmlFor="conf">Confirm Password</label>
                    </Form.Floating>
                    ...
                    <FloatingLabel className="mb-3" controlId="floatingSelectGrid">
                      ...
                      >
                        ...
                        <label style={{ color: this.state.error_user_role }} htmlFor="role">User Role</label>
                    </FloatingLabel>
                    ...
                    <FloatingLabel className="mb-3" controlId="floatingSelectGrid">
                      ...
                      >
                        ...
                        <label style={{ color: this.state.error_user_type }} htmlFor="role">User Type</label>
                    </FloatingLabel>
                    ...
                    <FloatingLabel className="mb-3" controlId="floatingSelectGrid">
                      ...
                      >
                        ...
                        <label style={{ color: this.state.error_user_status }} htmlFor="status">User Type</label>
                    </FloatingLabel>
