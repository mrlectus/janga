      ...
      <HashRouter>
        <Switch>
          ...
          <Route
            ...
            component={NewFoodScientistRegistrations}
          />
          <Route exact path="/licence-renewals" component={LicenceRenewals} />
          <Route
            exact
            path="/registration-renewals"
            component={RegistrationRenewals}
          />
          <Route exact path="/premises-renewals" component={PremisesRenewals} />
          <Route
            exact
            path="/print-food-scientist-record"
            component={PrintFoodScientistRecord}
          />
          <Route
            exact
            path="/print-licence-record"
            component={PrintLicenceRecord}
          />
          <Route
            exact
            path="/print-premises-record"
            component={PrintPremisesRecord}
          />
          <Route
            exact
            path="/print-inspection-record"
            component={PrintInspectionRecord}
          />
